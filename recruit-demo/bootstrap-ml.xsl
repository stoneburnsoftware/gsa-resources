...
<xsl:template name="my_page_header">
  ...
  <xsl:text disable-output-escaping="yes">&lt;head&gt;
    ...
    &lt;title&gt;E-Commerce - Demo with Typeahead&lt;/title&gt;

    &lt;!-- Bootstrap Core CSS --&gt;
    &lt;link href="http://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.2.0/css/bootstrap.css" rel="stylesheet"&gt;

    &lt;!-- Custom CSS --&gt;
    &lt;link href="http://googledrive.com/host/0B8L9xZxCeK5mbThDRWFHLTlCNW8/ecommerce-demo/css/landing-page.css" rel="stylesheet"&gt;

    &lt;!-- Custom Fonts --&gt;
    &lt;link href="http://googledrive.com/host/0B8L9xZxCeK5mbThDRWFHLTlCNW8/ecommerce-demo/font-awesome-4.1.0/css/font-awesome.min.css" rel="stylesheet" type="text/css"&gt;
        ...
        &lt;div class="container"&gt;
            ...
            &lt;div class="navbar-header"&gt;
                &lt;button data-target="#bs-example-navbar-collapse-1" data-toggle="collapse" class="navbar-toggle" type="button"&gt;
                    ...
                    &lt;span class="icon-bar"&gt;&lt;/span&gt;
                &lt;/button&gt;
				&lt;img width="164" height="46" alt="LOGO" href="#" src="http://googledrive.com/host/0B8L9xZxCeK5mbThDRWFHLTlCNW8/ecommerce-demo/img/logo.png"&gt; 
            ...
            &lt;div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse"&gt;
                &lt;ul class="nav navbar-nav navbar-right"&gt;
                    &lt;li&gt;
                        &lt;a href="#"&gt;&amp;nbsp;&lt;i class="fa fa-shopping-cart fa-fw"&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&lt;/i&gt;Cart&lt;/a&gt;
                    &lt;/li&gt;
                    &lt;li&gt;
                        &lt;a href="#"&gt;Profile&lt;/a&gt;
                    &lt;/li&gt;
...
<xsl:template name="my_page_footer">
  <span class="p">
    <xsl:text disable-output-escaping="yes">&lt;div id="center"&gt;
    &lt;div class="banner"&gt;
        ...
        &lt;div class="container"&gt;
            ...
            &lt;div class="row"&gt;
                &lt;div class="col-lg-6"&gt;
                    &lt;h2&gt;Connect to Cloud Sherpas&lt;/h2&gt;
                &lt;/div&gt;
                &lt;div class="col-lg-6"&gt;
                    &lt;ul class="list-inline banner-social-buttons"&gt;
                        &lt;li&gt;
                            &lt;a class="btn btn-default btn-circle" href=""&gt;&lt;i class="fa fa-twitter fa-fw"&gt;&lt;/i&gt; &lt;span class="network-name"&gt;&lt;/span&gt;&lt;/a&gt;
                        &lt;/li&gt;
                        &lt;li&gt;
                            &lt;a class="btn btn-default btn-circle" href=""&gt;&lt;i class="fa fa-facebook fa-fw"&gt;&lt;/i&gt; &lt;span class="network-name"&gt;&lt;/span&gt;&lt;/a&gt;
                        &lt;/li&gt;
                        &lt;li&gt;
                            &lt;a class="btn btn-default btn-circle" href="#"&gt;&lt;i class="fa fa-google-plus fa-fw"&gt;&lt;/i&gt; &lt;span class="network-name"&gt;&lt;/span&gt;&lt;/a&gt;
                        &lt;/li&gt;
						
                        &lt;li&gt;
                            &lt;a class="btn btn-default btn-circle" href="#"&gt;&lt;i class="fa fa-linkedin fa-fw"&gt;&lt;/i&gt; &lt;span class="network-name"&gt;&lt;/span&gt;&lt;/a&gt;
                        &lt;/li&gt;
						
                        &lt;li&gt;
                            &lt;a class="btn btn-default btn-circle" href="#"&gt;&lt;i class="fa fa-youtube-play fa-fw"&gt;&lt;/i&gt; &lt;span class="network-name"&gt;&lt;/span&gt;&lt;/a&gt;
                        &lt;/li&gt;
            ...
            &lt;div class="row"&gt;
                &lt;div class="col-lg-12"&gt;
                    &lt;ul class="list-inline"&gt;
                        ...
                        &lt;/li&gt;
                    &lt;/ul&gt;
                    &lt;p class="copyright text-muted small"&gt;Copyright &amp;copy; CloudSherpas 2014. All Rights Reserved&lt;/p&gt;
                &lt;/div&gt;
            &lt;/div&gt;
        &lt;/div&gt;
    &lt;/footer&gt;</xsl:text>
...
<select name="site">
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='airport_directions')]">
   <option value="airport_directions" selected="selected">airport_directions</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="airport_directions">airport_directions</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='argos_store_locator')]">
   <option value="argos_store_locator" selected="selected">argos_store_locator</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="argos_store_locator">argos_store_locator</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='bentley')]">
   <option value="bentley" selected="selected">bentley</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='bentley_models')]">
   <option value="bentley_models" selected="selected">bentley_models</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="bentley_models">bentley_models</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='bentley_preowned_demo')]">
   <option value="bentley_preowned_demo" selected="selected">bentley_preowned_demo</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="bentley_preowned_demo">bentley_preowned_demo</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='bentley_world_of_bentley')]">
   <option value="bentley_world_of_bentley" selected="selected">bentley_world_of_bentley</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="bentley_world_of_bentley">bentley_world_of_bentley</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='bupa_all')]">
   <option value="bupa_all" selected="selected">bupa_all</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="bupa_all">bupa_all</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='bupa_az')]">
   <option value="bupa_az" selected="selected">bupa_az</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="bupa_az">bupa_az</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='cs_office_locator')]">
   <option value="cs_office_locator" selected="selected">cs_office_locator</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="cs_office_locator">cs_office_locator</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='cv_search')]">
   <option value="cv_search" selected="selected">cv_search</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="cv_search">cv_search</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='daa_collection')]">
   <option value="daa_collection" selected="selected">daa_collection</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="daa_collection">daa_collection</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='ecommerce')]">
   <option value="ecommerce" selected="selected">ecommerce</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='eiu_collection')]">
   <option value="eiu_collection" selected="selected">eiu_collection</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="eiu_collection">eiu_collection</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='expert_search_football_coaches_collection')]">
   <option value="expert_search_football_coaches_collection" selected="selected">expert_search_football_coaches_collection</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="expert_search_football_coaches_collection">expert_search_football_coaches_collection</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='finance_demo')]">
   <option value="finance_demo" selected="selected">finance_demo</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="finance_demo">finance_demo</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='football_stadium_feed')]">
   <option value="football_stadium_feed" selected="selected">football_stadium_feed</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="football_stadium_feed">football_stadium_feed</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='football_stadium_locator')]">
   <option value="football_stadium_locator" selected="selected">football_stadium_locator</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="football_stadium_locator">football_stadium_locator</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='fs')]">
   <option value="fs" selected="selected">fs</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='geo_team_data')]">
   <option value="geo_team_data" selected="selected">geo_team_data</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="geo_team_data">geo_team_data</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='globalblue')]">
   <option value="globalblue" selected="selected">globalblue</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="globalblue">globalblue</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='globalblue_store_locator')]">
   <option value="globalblue_store_locator" selected="selected">globalblue_store_locator</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="globalblue_store_locator">globalblue_store_locator</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='hugo_test')]">
   <option value="hugo_test" selected="selected">hugo_test</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="hugo_test">hugo_test</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='icon')]">
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='job_search')]">
   <option value="job_search" selected="selected">job_search</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='lotus')]">
   <option value="lotus" selected="selected">lotus</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='rbs_image_results')]">
   <option value="rbs_image_results" selected="selected">rbs_image_results</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="rbs_image_results">rbs_image_results</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='rbs_office_feed')]">
   <option value="rbs_office_feed" selected="selected">rbs_office_feed</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="rbs_office_feed">rbs_office_feed</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='rte')]">
   <option value="rte" selected="selected">rte</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='technip_images')]">
   <option value="technip_images" selected="selected">technip_images</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="technip_images">technip_images</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='technip_office_locator')]">
   <option value="technip_office_locator" selected="selected">technip_office_locator</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="technip_office_locator">technip_office_locator</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='the_fa')]">
   <option value="the_fa" selected="selected">the_fa</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="the_fa">the_fa</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='training')]">
